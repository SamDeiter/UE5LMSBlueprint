...
export class DetailsRenderer {
  ...
  static renderAdvancedFields(variable) {
    return `
            ...
            ${
              ["int", "int64", "byte", "float", "double"].includes(
                variable.type
              )
                ? `
            <div class="detail-row">
                ...
                <div class="detail-row" style="flex-direction: column; align-items: stretch; padding: 0;">
                    ...
                    <div style="display: flex; gap: 4px; padding: 4px 8px; background: rgba(0,0,0,0.2);">
                        <div style="flex: 1; display: flex; flex-direction: column; gap: 2px;">
                            ...
                            <input type="number" class="details-input" value="${
                              parsed.x
                            }" step="0.01" data-prop="defaultValue" data-vector-component="x" style="padding: 2px 4px; font-size: 10px;">
                        </div>
                        <div style="flex: 1; display: flex; flex-direction: column; gap: 2px;">
                            <label style="color: #999; font-size: 9px;">Y</label>
                            <input type="number" class="details-input" value="${
                              parsed.y
                            }" step="0.01" data-prop="defaultValue" data-vector-component="y" style="padding: 2px 4px; font-size: 10px;">
                        </div>
                        <div style="flex: 1; display: flex; flex-direction: column; gap: 2px;">
                            <label style="color: #999; font-size: 9px;">Z</label>
                            <input type="number" class="details-input" value="${
                              parsed.z
                            }" step="0.01" data-prop="defaultValue" data-vector-component="z" style="padding: 2px 4px; font-size: 10px;">
                        </div>
                    </div>
                </div>
            `;
